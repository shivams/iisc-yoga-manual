...
\title{\Huge \textbf{Yoga Manual}  \\ \huge IISc Yoga Club \footnote{\url{https://sites.google.com/site/iiscyogaclub}}}
% Author
\author{\textsc{Vivek Shastri et. al.}\thanks{...and all the students who have made it happen.}}
...
\begin{titlepage}
	\centering
	\includegraphics[width=0.30\textwidth]{IIScBilingualLogojpg.png}\par\vspace{1cm}
%	{\scshape\LARGE Indian Institute of Science \par}
	\vspace{1.0cm}
	{\Huge\bfseries Yoga Manual\par}
	\vspace{1cm}
	{\scshape\Large IISc Yoga Club\footnote{\url{https://sites.google.com/site/iiscyogaclub}}\par}

	\vspace{2cm}
	{\Large\itshape Vivek Shastri et. al.\footnote{...and all the students who have made it happen.}\par}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{dedication}
Dedicated to the sage Patanjali.
\end{dedication}
